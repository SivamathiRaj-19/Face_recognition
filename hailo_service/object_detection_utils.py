...
class ObjectDetectionUtils:
    ...
    def extract_detections(self, input_data: list, threshold: float = 0.5) -> dict:
        ...
        num_detections = 0
        # print("output_array type:", type(input_data))
        # if hasattr(input_data, 'shape'):
        #     print("output_array shape:", input_data.shape)
        # else:
        #     print("output_array len:", len(input_data))
        for i, detection in enumerate(input_data):
            ...
            for det in detection:
                ...
                # Ensure score is a scalar value for comparison
    ...
    def extraction_feature(self, input_data: list, threshold: float = 0.5) -> dict:
        return input_data
